...
export const sampleReportData: ReportSummaryData = {
  ...
  members: [
    ...
    { id: '3', name: '要員C', proposals: 5, interviews: 3, offers: 1, unitPrice: 400000, casePoolSize: 8 },
    {
      id: '4',
      name: '要員D',
      proposals: 5,
    ...
    { id: '5', name: '要員E', proposals: 5, interviews: 5, offers: 0, unitPrice: 500000, casePoolSize: 6 },
    {
      id: '6',
      name: '要員F',
      proposals: 5,
